...
namespace Vacation.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,ProjectId,TeamLeadId,Id")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,ProjectId,TeamLeadId,Id")] Team team)
        {
            if (id != team.Id)
            {
                return NotFound();
